...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($_FILES['pimage']['name'][0])) {
        ...
        if (!empty($uploaded_files)) {
            ...
            $sql = "UPDATE post SET head='$head', detail='$detail', price='$price', location='$location', pimage='$pimage' WHERE idPost = $idPost AND idUser = $userId";
        }
    }
...
<div class="w3-container" style="margin-left:auto; margin-right:auto; max-width: 800px; min-height:90vh;">
        ...
        <div class="w3-section">
            <div class="w3-margin-bottom">
                ...
                foreach ($current_images as $image) {
                    echo '<img src="./upload_system/uploads/' . $image . '" style="width: 100px; height: 100px; object-fit: cover; margin-right: 10px; border-radius:8px;">';
                }
                ?>
            </div>
