...
<style>
    ...
    .custom-card {
        ...
        display: flex;
        flex-direction: column;
        text-decoration: none; /* เพิ่มเพื่อทำให้การ์ดไม่มีขีดเส้นใต้ */
    }
...
<div class="w3-row-padding w3-padding-16" style="margin-left:auto; margin-right:auto; max-width:1600px; min-height:80vh;">
    ...
    ?>
            <div class="w3-quarter w3-margin-bottom w3-margin-right">
                ...
                <div class="edit-delete-container">
                    <a href="edit_post.php?idPost=<?php echo $row['idPost']; ?>" class="w3-btn w3-blue">แก้ไข</a>
                    <a href="delete_post.php?idPost=<?php echo $row['idPost']; ?>" class="w3-btn w3-red" onclick="return confirm('คุณแน่ใจหรือว่าต้องการลบโพสต์นี้?');">ลบ</a>
                </div>
            </div>
    <?php
        }
